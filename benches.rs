...
#[divan::bench(args = [100])]
fn bench_00056(bencher: divan::Bencher, n: usize) {
    bencher.bench_local(move || euler::euler::e00056::solve(n));
}

#[divan::bench(args = [1_000])]
fn bench_00057(bencher: divan::Bencher, n: usize) {
    bencher.bench_local(move || euler::euler::e00057::solve(n));
}

#[divan::bench()]
fn bench_00058(bencher: divan::Bencher) {
    bencher.bench_local(euler::euler::e00058::solve);
}

#[divan::bench()]
fn bench_00059(bencher: divan::Bencher) {
    bencher.bench_local(euler::euler::e00059::solve);
}

#[divan::bench(args = [3, 4])]
fn bench_00060(bencher: divan::Bencher, n: usize) {
    bencher.bench_local(move || euler::euler::e00060::solve(n));
}
